...
public class RemoveUserPage {
    ...
    public RemoveUserPage(DatabaseHelper dbHelper, Stage primaryStage, int userId, String userName) {
            ...
            try {
                ...
                confirmationDialog.showAndWait().ifPresent(response -> {
                    if (response == ButtonType.OK) {
                        ...
                        AdminHomePage adminHomePage = new AdminHomePage(adminUserId, adminUserName);
